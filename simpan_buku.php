...
if ($size > 0) {
	...
	if ($simpan == "EDIT") {
		...
		$sql = "update buku set kode = '$kode', judul ='$judul', pengarang = '$pengarang', 
		penerbit = '$penerbit', stok = '$stok', foto = '$foto' where idbuku = $idbuku";
...
function buat_thumbnail($file_src, $file_dst){
	...
	$img_dst = imagecreatetruecolor($w_dst, $h_dst); // example
